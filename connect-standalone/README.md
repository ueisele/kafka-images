...
```bash
connect-standalone/build.sh --build --tag 3.3.1 --openjdk-release 17 --openjdk-version 17.0.5
```
...
`Usage: connect-standalone/build.sh [--build] [--push] [--user ueisele] [--github-repo apache/kafka] [ [--commit-sha b172a0a] [--tag 3.3.1] [--branch trunk] [--pull-request 9999] ] [--openjdk-release 17] [--openjdk-version 17.0.5]`
